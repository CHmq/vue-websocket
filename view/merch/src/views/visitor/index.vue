...
import { getVisitInfo } from '../../network/Interface/visitor'
...
export default {
  ...
  data () {
    ...
    return {
      ...
      // UserId: JSON.parse(sessionStorage.getItem('result')).merch.id,
      UserId: JSON.parse(sessionStorage.getItem('resInfo')).merch.id,
      page: 1,
      pagination: {
        total: 0,
        pageSize: 5,
