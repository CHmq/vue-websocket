  ...
  <page-header-wrapper>
    ...
    <div class="datagl datagl2">
      ...
      <div class="datagl-item">
        ...
        <a-row class="item-contentlist" justify="space-around" align="middle">
          <a-col :span="7" class="list-item" @click="topage">
            <img src="http://kefu.xuandev.com/agent/pic1.png" alt="">
            <div class="item-text">
              来源统计
            </div>
          </a-col>
          <a-col :span="7" :offset="1" class="list-item" @click="toLand">
            <img src="http://kefu.xuandev.com/agent/pic2.png" alt="">
            <div class="item-text">
              着陆页统计
            </div>
          </a-col>
          <a-col :span="7" :offset="1" class="list-item" @click="toDialogue">
            <img src="http://kefu.xuandev.com/agent/pic3.png" alt="">
            <div class="item-text">
              对话页统计
            </div>
          </a-col>
...
.datagl2{
    ...
    .item-contentlist{
        ...
        .list-item{
            // width: 210px;
            border: 1px solid #e6e6e6c9;
            height: 120px;
            text-align: center;
            box-shadow: 2px 2px 8px 0px rgba(29, 39, 84, 0.2);
            border-radius: 10px;
            display: flex;
