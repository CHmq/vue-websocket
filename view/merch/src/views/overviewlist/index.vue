...
export default {
    ...
    methods: {
        ...
        keData () {
            const that = this
            const merchid = JSON.parse(sessionStorage.getItem('resInfo')).merch.id
            // const merchid = sessionStorage.getItem('resInfo').merch.id
