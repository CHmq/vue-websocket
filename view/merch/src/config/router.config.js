...

  {
    ...
    children: [
      ...
      // forms
      {
        ...
        meta: { title: '对话平台', icon: 'form', permission: ['form'] }
        // path: '/form',
      ...
      // list
      {
        ...
        meta: { title: '客服', icon: 'table', permission: ['table'] },
        children: [
          {
            ...
            meta: { title: '客服管理', keepAlive: true, permission: ['table'] }
          },
          {
            path: '/agent/Agentgroup',
            name: 'Agentgroup',
            component: () => import('@/views/list/Agentgroup'),
            meta: { title: '客服分组', keepAlive: true, permission: ['table'] }
          },
          {
            path: '/agent/AgentLink',
            name: 'AgentLink',
            component: () => import('@/views/list/AgentLink'),
            meta: { title: '生成聊天链接', keepAlive: true, permission: ['table'] }
          }
          // {
          //   path: '/list/card',
          //   name: 'CardList',
      ...
      },
      {
        ...
        meta: { title: '报表', icon: 'area-chart', hideHeader: true },
